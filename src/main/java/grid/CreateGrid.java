...
public class CreateGrid {
    ...
    public static void main(String[] args) throws FactoryException, IOException {
        ...
        Geometry boundary = AccessibilityUtils.readBoundary(Resources.instance.getString(Properties.REGION_BOUNDARY));
        ...
        AccessibilityUtils.writeFeaturesToGpkg(grid.getFeatures(),description,outputFile);
    }
}
