...
import disutility.components.JctStress;
import disutility.components.LinkAmbience;
import disutility.components.LinkComfort;
import disutility.components.LinkStress;
...
public class CompositeDisutility implements TravelDisutility {
    ...
    public CompositeDisutility(String mode, TravelTime tt, Boolean dayNightOverride,
